...
// SI dividers
nano::uint128_t const Gxrb_ratio = nano::uint128_t ("1000000000000000000000000000000000000"); // 10^36
nano::uint128_t const Mxrb_ratio = nano::uint128_t ("1000000000000000000000000000000000"); // 10^33
nano::uint128_t const kxrb_ratio = nano::uint128_t ("1000000000000000000000000000000"); // 10^30
nano::uint128_t const xrb_ratio = nano::uint128_t ("1000000000000000000000000000"); // 10^27
nano::uint128_t const mxrb_ratio = nano::uint128_t ("1000000000000000000000000"); // 10^24
nano::uint128_t const uxrb_ratio = nano::uint128_t ("1000000000000000000000"); // 10^21
